...
class clsMainWindow(QMainWindow):
    def __init__(self):
        ...
        self.ui.actionPurchase_Bill.triggered.connect(self.Purchase_BillClick)
    ...
    def Purchase_BillClick(self):
        self.p1=clsPurchase_Bill()
        self.ui.mdiArea.addSubWindow(self.p1)
        self.p1.show()
